...
function SelectNoteCompo() {
  return (
    <Box display="flex" flexDirection="column" alignItems="center" justifyContent="center" height="100vh" gap={3} fontWeight="fontWeightBold">
      ...
      <Typography variant="body1" color="#fff" textAlign="center" px={4}>
